package ua.graduateproject.restaurant.web;
...
import ua.graduateproject.restaurant.util.exception.ApplicationException;
import ua.graduateproject.restaurant.util.exception.ErrorInfo;
...
import static ua.graduateproject.restaurant.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public static final String EXCEPTION_DUPLICATE_DATETIME = "exception.restaurant.duplicateDateTime";
            ...
            new HashMap<String, String>() {
                {
                    ...
                    put("restaurant_unique_address_idx", EXCEPTION_DUPLICATE_ADDRESS);
                    put("restaurant_unique_menu_date_idx", EXCEPTION_DUPLICATE_DATETIME);
                }
            });
